  ...
  <header
    ...
    <nav class="flex justify-between items-center">
      <div class="flex items-center">
        <router-link to="/">
          <img src="/images/logo_fatec.png" alt="Logo da Fatec" class="h-12 md:h-14 w-auto" />
        </router-link>
      </div>
      ...
      <ul class="hidden md:flex items-center space-x-8 text-lg">
        ...
        <li class="relative" ref="componentesMenuRef">
          <button ref="componentesButtonRef" @click="toggleComponentesDropdown" :class="{
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform duration-200"
              :class="{ 'rotate-180': isComponentesDropdownOpen }" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div v-if="isMobileMenuOpen"
      ...
      <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 p-4 space-y-2">
          ...
          <div class="space-y-1">
            <button @click="toggleMobileComponentes" :class="{
              ...
              <svg class="w-4 h-4 transition-transform duration-200"
                :class="{ 'rotate-180': isMobileComponentesExpanded }" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
            ...
            <transition name="accordion-slide">
              <div v-if="isMobileComponentesExpanded" class="pl-4 space-y-1">
                <router-link to="/componentes/placa-mae" @click="closeMobileMenu" active-class="bg-white/20 font-medium"
                ...
                <router-link to="/componentes/ram" @click="closeMobileMenu" active-class="bg-white/20 font-medium"
                  class="block px-4 py-2 rounded-lg text-white text-sm transition-all duration-200 hover:bg-white/10 border-l-2 border-white/20">
                  RAM
                </router-link>
                <router-link to="/componentes/hd-ssd" @click="closeMobileMenu" active-class="bg-white/20 font-medium"
                  class="block px-4 py-2 rounded-lg text-white text-sm transition-all duration-200 hover:bg-white/10 border-l-2 border-white/20">
                  HDD/SSD
                </router-link>
                <router-link to="/componentes/fonte" @click="closeMobileMenu" active-class="bg-white/20 font-medium"
                  class="block px-4 py-2 rounded-lg text-white text-sm transition-all duration-200 hover:bg-white/10 border-l-2 border-white/20">
                  Fonte
                </router-link>
                <router-link to="/componentes/gabinete" @click="closeMobileMenu" active-class="bg-white/20 font-medium"
                  class="block px-4 py-2 rounded-lg text-white text-sm transition-all duration-200 hover:bg-white/10 border-l-2 border-white/20">
                  Gabinete
                </router-link>
                <router-link to="/componentes/midia" @click="closeMobileMenu" active-class="bg-white/20 font-medium"
                  class="block px-4 py-2 rounded-lg text-white text-sm transition-all duration-200 hover:bg-white/10 border-l-2 border-white/20">
                  Mídias
                </router-link>
          ...
          <router-link to="/acervo" @click="closeMobileMenu"
            class="block px-4 py-3 rounded-lg text-white transition-all duration-300 hover:bg-white/10"
            active-class="bg-white/20 font-semibold border border-white/30">
            <div class="flex items-center gap-3">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <teleport to="body">
    <transition name="dropdown-fade">
      <div v-if="isComponentesDropdownOpen" id="componentesDropdown"
        ...
        <ul class="text-base">
          <li>
            <router-link to="/componentes/placa-mae" @click="closeComponentesDropdown"
              active-class="bg-white/20 font-medium"
          ...
          <li>
            <router-link to="/componentes/ram" @click="closeComponentesDropdown" active-class="bg-white/20 font-medium"
              class="nav-component-link block py-2.5 px-4 hover:bg-white/10 transition-all duration-200 border-b border-white/5 last:border-0">
              RAM
            </router-link>
          </li>
          <li>
            <router-link to="/componentes/hd-ssd" @click="closeComponentesDropdown"
              active-class="bg-white/20 font-medium"
              class="nav-component-link block py-2.5 px-4 hover:bg-white/10 transition-all duration-200 border-b border-white/5 last:border-0">
              HDD/SSD
            </router-link>
          ...
          <li>
            <router-link to="/componentes/fonte" @click="closeComponentesDropdown"
              active-class="bg-white/20 font-medium"
              class="nav-component-link block py-2.5 px-4 hover:bg-white/10 transition-all duration-200 border-b border-white/5 last:border-0">
              Fonte
            </router-link>
          ...
          <li>
            <router-link to="/componentes/gabinete" @click="closeComponentesDropdown"
              active-class="bg-white/20 font-medium"
              class="nav-component-link block py-2.5 px-4 hover:bg-white/10 transition-all duration-200 border-b border-white/5 last:border-0">
              Gabinete
            </router-link>
          ...
          <li>
            <router-link to="/componentes/midia" @click="closeComponentesDropdown"
              active-class="bg-white/20 font-medium"
              class="nav-component-link block py-2.5 px-4 hover:bg-white/10 transition-all duration-200 border-b border-white/5 last:border-0">
              Mídias
            </router-link>
